...
import 'package:Glowzel/module/welcome/pages/skin_health.dart';
...
import '../../scan/cubit/skin_analysis_cubit.dart';
import '../../scan/cubit/skin_analysis_state.dart';
...
class _ScanFaceViewState extends State<ScanFaceView>
  ...
  void _handleAnalysisResult(SkinAnalysisState state) async {
    ...
    if (state.status == SkinAnalysisStatus.success) {
      if (mounted) {
        NavRouter.push(context, const SkinHealth());
      }
