...
import 'package:Glowzel/module/scan/model/skin_analysis_response.dart';
...
class SkinHealth1 extends StatefulWidget {
  const SkinHealth1({super.key});

  @override
  State<SkinHealth1> createState() => _SkinHealth1State();
}

class _SkinHealth1State extends State<SkinHealth1> {
  ...
  void initState() {
    ...
    skinHealthFuture = fetchSkinHealth1();
    loadImagePath();
  }
  ...
  Future<SkinAnalysisResponse?> fetchSkinHealth1() async {
    try {
