...
class _OTPTextFieldState extends State<OTPTextField> {
  ...
  Widget buildTextField(BuildContext context, int index) {
    ...
    return Container(
      width:50,
      height: 35,
      margin: EdgeInsets.only(right: index == widget.length - 1 ? 0 : 4),
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          border: _getBorder(Color(0xFFABABAB)),
          focusedBorder: _getBorder(AppColors.lightGreen),
          enabledBorder: _getBorder(Color(0xffABABAB)),
          disabledBorder: _getBorder(Color(0xffABABAB)),
